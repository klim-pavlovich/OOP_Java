...
//
//    //region Constructors
//    JobSeeker(String name, String surName, String specialization, int salary, int experienceYears) {
//        this.setName(name);
...
//    }
//    JobSeeker(String name, String surName, String specialization, int salary, int experienceYears, String backgroundDescription) {
//        this.setName(name);
//        this.setSurName(surName);
//        this.setSpecialization(specialization);
//        this.setSalary(salary);
