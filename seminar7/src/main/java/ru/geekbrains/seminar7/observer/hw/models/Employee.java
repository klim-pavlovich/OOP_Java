...
public abstract class Employee {
    ...
    //region Constructors
    Employee(String name, String surName, String specialization, int salary, int experienceYears) {
        this.setName(name);
    ...
    Employee(String name, String surName, String specialization, int salary, int experienceYears, String backgroundDescription) {
        this.setName(name);
        this.setSurName(surName);
        this.setSpecialization(specialization);
        this.setSalary(salary);
